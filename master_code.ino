...
if ((millis() - lastTime) > timerDelay) {
    ...
    if(WiFi.status()== WL_CONNECTED){
      ...
      String httpRequestData = "api_key=" + apiKey + "&field1=" + String(beatsPerMinute)+"&field2=" + String(a)+"&field6=" + String(gt)+"&field3=" + String(xy)+"&field5=" + String(p);
                 
      // Send HTTP POST request
      int httpResponseCode = http.POST(httpRequestData);//submitted to cloud
